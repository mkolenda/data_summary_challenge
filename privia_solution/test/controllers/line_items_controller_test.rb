...
class LineItemsControllerTest < ActionController::TestCase
  ...
  test "should create line_item" do
    assert_difference('LineItem.count') do
      post :create, line_item: { item_description: @line_item.item_description, item_price: @line_item.item_price, merchant_address: @line_item.merchant_address, merchant_name: @line_item.merchant_name, purchase_count: @line_item.purchase_count, purchaser_name: @line_item.purchaser_name }
    end
